...
class hasil_jnt(models.Model):
    _name='hasil.jnt'
    _description="Hasil bagi jurnal nasional"
    _auto = False
    ...
    #         param = 0
    #         idparam = self.env['ir.config_parameter'].sudo().search([('key', '=', 'jnt_' + str(line.tahun))])
    #         if idparam:
    ...
    def get_hasil(self):
        for line in self:
            line.hasil = line.jumlah_record / line.jumlah_dosen
            param = 0
            tahun = line.env['rasio.parameter'].sudo().search([], limit=1, offset=2)  # Mengambil baris ketiga dari model rasio.parameter
            if tahun:
                param = getattr(tahun, 'thn_' + line.tahun, 0)  # Mengambil nilai tahun yang sesuai dengan tahun pada model hasil.jnt
            stat = '1'
            if line.hasil >= param:
                stat = '1'
            else:
...
# class hasil_nasional(models.Model):
#     _name="hasil.nasional"
#     _description="Hasil bagi jurnal nasional"
...
#     #mengambil data hasil jurnal reputasi 2021 dari model hitung.nasional
#     @api.depends('jurnal_2021')
#     def compute_jurnal_2021(self):
#         hitung_nasional_rec = self.env['hitung.nasional'].search([])
#         if hitung_nasional_rec:
#             self.jurnal_2021 = hitung_nasional_rec[0].result_2021
#         else:
#             self.jurnal_2021 = 0.0

#     #otomatis memperbarui field setiap terjadi perubahan pada field hasil_2021 model hitung.nasional
...
#     #mengambil data hasil jurnal reputasi 2022 dari model hitung.nasional
#     @api.depends('jurnal_2022')
#     def compute_jurnal_2022(self):
#         hitung_nasional_rec = self.env['hitung.nasional'].search([])
#         if hitung_nasional_rec:
#             self.jurnal_2022 = hitung_nasional_rec[0].result_2022
#         else:
#             self.jurnal_2022 = 0.0

#     #otomatis memperbarui field setiap terjadi perubahan pada field hasil_2022 model hitung.nasional
...
#     #mengambil data hasil jurnal reputasi 2023 dari model hitung.nasional
#     @api.depends('jurnal_2023')
#     def compute_jurnal_2023(self):
#         hitung_nasional_rec = self.env['hitung.nasional'].search([])
#         if hitung_nasional_rec:
#             self.jurnal_2023 = hitung_nasional_rec[0].result_2023
#         else:
#             self.jurnal_2023 = 0.0

#     #otomatis memperbarui field setiap terjadi perubahan pada field hasil_2023 model hitung.nasional
#     @api.onchange('jurnal_2023')
#     def hitung_nasional_2023(self):
#         hitung_nasional_rec = self.env['hitung.nasional'].search([])
#         if hitung_nasional_rec:
#             self.jurnal_2023 = hitung_nasional_rec[0].result_2023
#         else:
...
#     #mengambil data hasil jurnal reputasi 2024 dari model hitung.nasional
#     @api.depends('jurnal_2024')
#     def compute_jurnal_2024(self):
#         hitung_nasional_rec = self.env['hitung.nasional'].search([])
#         if hitung_nasional_rec:
#             self.jurnal_2024 = hitung_nasional_rec[0].result_2024
#         else:
#             self.jurnal_2024 = 0.0

#     #otomatis memperbarui field setiap terjadi perubahan pada field hasil_2024 model hitung.nasional
...
#     #mengambil data hasil jurnal reputasi 2025 dari model hitung.nasional
#     @api.depends('jurnal_2025')
#     def compute_jurnal_2025(self):
#         hitung_nasional_rec = self.env['hitung.nasional'].search([])
#         if hitung_nasional_rec:
#             self.jurnal_2025 = hitung_nasional_rec[0].result_2025
#         else:
#             self.jurnal_2025 = 0.0

#     #otomatis memperbarui field setiap terjadi perubahan pada field hasil_2025 model hitung.nasional
...
#     #mengambil data hasil jurnal reputasi 2026 dari model hitung.nasional
#     @api.depends('jurnal_2026')
#     def compute_jurnal_2026(self):
#         hitung_nasional_rec = self.env['hitung.nasional'].search([])
#         if hitung_nasional_rec:
#             self.jurnal_2026 = hitung_nasional_rec[0].result_2026
#         else:
#             self.jurnal_2026 = 0.0

#     #otomatis memperbarui field setiap terjadi perubahan pada field hasil_2026 model hitung.nasional
