...
class hitung_ji(models.Model):
    _name='hitung.ji'
    _description='Hitung data jurnal internasional'
    _auto = False
...
# class hitung_internasional(models.Model):
#     _name='hitung.internasional'
#     _description='Hitung data jurnal internasional'
...
#         jurnal_2021_rec = self.env['jurnal.internasional'].search([('tahun', '=', 2021)])
...
#         jurnal_2022_rec = self.env['jurnal.internasional'].search([('tahun', '=', 2022)])
...
#         jurnal_2023_rec = self.env['jurnal.internasional'].search([('tahun', '=', 2023)])
...
#         jurnal_2024_rec = self.env['jurnal.internasional'].search([('tahun', '=', 2024)])
...
#         jurnal_2025_rec = self.env['jurnal.internasional'].search([('tahun', '=', 2025)])
...
#         jurnal_2026_rec = self.env['jurnal.internasional'].search([('tahun', '=', 2026)])
