...
class hitung_jnt(models.Model):
    _name='hitung.jnt'
    _description='Hitung data jurnal nasional'
    _auto = False
...
# class hitung_nasional(models.Model):
#     _name='hitung.nasional'
#     _description='Hitung data jurnal nasional'
...
#         jurnal_2021_rec = self.env['jurnal.nasional'].search([('tahun', '=', 2021)])
...
#         jurnal_2022_rec = self.env['jurnal.nasional'].search([('tahun', '=', 2022)])
...
#         jurnal_2023_rec = self.env['jurnal.nasional'].search([('tahun', '=', 2023)])
...
#         jurnal_2024_rec = self.env['jurnal.nasional'].search([('tahun', '=', 2024)])
...
#         jurnal_2025_rec = self.env['jurnal.nasional'].search([('tahun', '=', 2025)])
...
#         jurnal_2026_rec = self.env['jurnal.nasional'].search([('tahun', '=', 2026)])
...
#     @api.depends('jumlah_dosen', 'jurnal_2021')
#                  #, 'jurnal_2022', 'jurnal_2023', 'jurnal_2024', 'jurnal_2025', 'jurnal_2026')
#     def compute_result(self):
#         for rec in self:
#             if rec.jurnal_2021 == 0:
#                 rec.result = 0.0
#             else:
#                 rec.result = rec.jumlah_dosen / rec.jurnal_2021
...
#     @api.onchange('jumlah_dosen', 'jurnal_2021')
#                   #, 'jurnal_2022', 'jurnal_2023', 'jurnal_2024', 'jurnal_2025', 'jurnal_2026')
#     def onchange_compute_result(self):
#         if self.jurnal_2021 == 0:
#             self.result = 0.0
#         else:
#             self.result = self.jumlah_dosen / self.jurnal_2021
