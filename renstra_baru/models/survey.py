...
class survey_kepuasan(models.Model):
    ...
    kepuasan_bebangaji = fields.Selection(string='Kesempatan mendapatkan beban kerja sesuai dengan keahlian/kompetensi', selection=[('1', '1'), ('2', '2'),('3','3'),('4','4')])
    ketersediaan_sop = fields.Selection(string='Ketersediaan SOP untuk menjalankan tugas Tri Dharma Perguruan Tinggi', selection=[('1', '1'), ('2', '2'),('3','3'),('4','4')])
    sarpras_pembelajaran = fields.Selection(string='Ketersediaan sarana prasarana pendukung kegiatan pembelajaran', selection=[('1', '1'), ('2', '2'),('3','3'),('4','4')])
    sarpras_peneltian = fields.Selection(string='Ketersediaan sarana prasarana pendukung kegiatan penelitian dan pengabdian kepada masyarakat', selection=[('1', '1'), ('2', '2'),('3','3'),('4','4')])
    ...
    fasilitas_informasi_penelitian = fields.Selection(string='Ketersediaan fasilitas memperoleh informasi dan pelayanan melakukan kegiatan penelitian', selection=[('1', '1'), ('2', '2'),('3','3'),('4','4')])
    fasilitas_informasi_pengabdian = fields.Selection(string='Ketersediaan fasilitas memperoleh informasi dan pelayanan melakukan kegiatan pengabdian kepada masyarakat', selection=[('1', '1'), ('2', '2'),('3','3'),('4','4')])
